...
<body>	
	...
	else if(dao.save(bean).equals("success2")){
		RequestDispatcher rdDispatcher=request.getRequestDispatcher("AdminProfile2.jsp");
		rdDispatcher.forward(request,response);
	}
	else if(dao.save(bean).equals("success3")){
		RequestDispatcher rdDispatcher=request.getRequestDispatcher("AdminProfile3.jsp");
		rdDispatcher.forward(request,response);
	}
	else if(dao.save(bean).equals("success4")){
		RequestDispatcher rdDispatcher=request.getRequestDispatcher("AdminProfile4.jsp");
		rdDispatcher.forward(request,response);
	}
	else{
